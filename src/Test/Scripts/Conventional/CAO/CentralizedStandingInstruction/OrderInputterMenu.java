package Test.Scripts.Conventional.CAO.CentralizedStandingInstruction;
...
public class OrderInputterMenu extends BaseClass {
    ...
    @Test(groups = {"CaoAuthorizer"},dataProvider = "StandingOrderAuth")
    ...
    @Test(groups = {"CaoAuthorizer"},dataProvider = "UnauthorizedList")
