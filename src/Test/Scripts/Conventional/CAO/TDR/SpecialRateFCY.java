...
public class SpecialRateFCY extends BaseClass {

    String Txn;
    String FILE_PATH = System.getProperty("user.dir")+"\\Excel Data\\TDR\\SpecialRateFCY.xlsx";

    @Test(groups = {"InputterTDR"}, dataProvider = "excelDataSpecialRateFCY")

    public void SpecialRateFCY(Map<String, String> testData) throws IOException, InterruptedException {

        PageObject.menu_Dropdown(" Centralized TDR ");
        PageObject.menu_Dropdown("Term Deposits - Special Rate");
        PageObject.menu_Link("Create Term Deposits FCY (Special Rate) ");
...
//        PageObject.authorizeByTxn(testData.get("Transaction Number"));
    ...
    @DataProvider(name = "excelDataSpecialRateFCY")
    ...
    public static void saveAccNumToFile(String accNumber) throws IOException {
        ...
        File file = new File(System.getProperty("user.dir") + "\\Data\\SpecialRateFCY.xlsx");
    ...
    String FILE_PATH2 = System.getProperty("user.dir") + "\\Data\\SpecialRateFCY.xlsx";

    @Test(groups = {"AuthorizerTDR"}, dataProvider = "DataSpecialRateFCY")

    public void SpecialRateFCYAuth(Map<String, String> testData) throws IOException, InterruptedException {
    ...
    @DataProvider(name = "DataSpecialRateFCY")
