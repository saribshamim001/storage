...
public class BackDatedTermDepositsFCY extends BaseClass {

    String Txn;
    String FILE_PATH = System.getProperty("user.dir")+"\\Excel Data\\TDR\\BackDatedTermDepositsFCY.xlsx";

    @Test(groups = {"InputterTDR"}, dataProvider = "excelDataBackDatedTermDepositsFCY")

    public void BackDatedTermDepositsFCY(Map<String, String> testData) throws IOException, InterruptedException {

        PageObject.menu_Dropdown(" Centralized TDR ");
        PageObject.menu_Dropdown("Back Dated Term Deposits ");
        PageObject.menu_Link("Back Dated Term Deposit FCY (Special Rate)  ");
...
//        PageObject.click_Locator("fieldName:EXP.DATE");
    ...
    @DataProvider(name = "excelDataBackDatedTermDepositsFCY")
    ...
    public static void saveAccNumToFile(String accNumber) throws IOException {
        ...
        File file = new File(System.getProperty("user.dir") + "\\Data\\BackDatedTermDepositsFCY.xlsx");
    ...
    String FILE_PATH2 = System.getProperty("user.dir") + "\\Data\\BackDatedTermDepositsFCY.xlsx";

    @Test(groups = {"AuthorizerTDR"}, dataProvider = "DataBackDatedTermDepositsFCY")

    public void BackDatedTermDepositsFCYAuth(Map<String, String> testData) throws IOException, InterruptedException {
    ...
    @DataProvider(name = "DataBackDatedTermDepositsFCY")
