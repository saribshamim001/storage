...
public class SpecialRateLCY extends BaseClass {

    String Txn;
    String FILE_PATH = System.getProperty("user.dir")+"\\Excel Data\\TDR\\SpecialRateLCY.xlsx";

    @Test(groups = {"InputterTDR"}, dataProvider = "excelDataSpecialRateLCY")

    public void SpecialRateLCY(Map<String, String> testData) throws IOException, InterruptedException {

        PageObject.menu_Dropdown(" Centralized TDR ");
        PageObject.menu_Dropdown("Term Deposits - Special Rate");
        PageObject.menu_Link("Create Term Deposits LCY (Special Rate) ");
...
//        PageObject.click_Locator("fieldName:EXP.DATE");
        ...
        //PageObject.commitDeal("SpecialRateLCY");
...
//        PageObject.authorizeByTxn(testData.get("Transaction Number"));
    ...
    @DataProvider(name = "excelDataSpecialRateLCY")
    ...
    public static void saveAccNumToFile(String accNumber) throws IOException {
        ...
        File file = new File(System.getProperty("user.dir") + "\\Data\\SpecialRateLCY.xlsx");
    ...
    String FILE_PATH2 = System.getProperty("user.dir") + "\\Data\\SpecialRateLCY.xlsx";

    @Test(groups = {"AuthorizerTDR"}, dataProvider = "DataSpecialRateLCY")

    public void SpecialRateLCYAuth(Map<String, String> testData) throws IOException, InterruptedException {
    ...
    @DataProvider(name = "DataSpecialRateLCY")
