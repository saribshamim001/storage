...
public class BackDatedTermDepositsLCY extends BaseClass {

    String Txn;
    String FILE_PATH = System.getProperty("user.dir")+"\\Excel Data\\TDR\\BackDatedTermDepositsLCY.xlsx";

    @Test(groups = {"InputterTDR"}, dataProvider = "excelDataBackDatedTermDepositsLCY")

    public void BackDatedTermDepositsLCY(Map<String, String> testData) throws IOException, InterruptedException {

        PageObject.menu_Dropdown(" Centralized TDR ");
        PageObject.menu_Dropdown("Back Dated Term Deposits ");
        PageObject.menu_Link("Back Dated Term Deposit LCY (Special Rate)  ");
...
//        PageObject.click_Locator("fieldName:PROFIT.PAY.TERM");
...
//        PageObject.click_Locator("fieldName:EXP.DATE");
        ...
        PageObject.commitDeal("BackDatedTermDepositsLCY");
    ...
    @DataProvider(name = "excelDataBackDatedTermDepositsLCY")
    ...
    public static void saveAccNumToFile(String accNumber) throws IOException {
        ...
        File file = new File(System.getProperty("user.dir") + "\\Data\\BackDatedTermDepositsLCY.xlsx");
    ...
    String FILE_PATH2 = System.getProperty("user.dir") + "\\Data\\BackDatedTermDepositsLCY.xlsx";

    @Test(groups = {"AuthorizerTDR"}, dataProvider = "DataBackDatedTermDepositsLCY")

    public void BackDatedTermDepositsLCYAuth(Map<String, String> testData) throws IOException, InterruptedException {

        PageObject.menu_Dropdown(" Centralized TDR");
        PageObject.childmenu_Dropdown("Authorization Of TDR",1);
        PageObject.menu_Link("Authorization of Back Dated Term Deposits  ");
    ...
    @DataProvider(name = "DataBackDatedTermDepositsLCY")
