...
public class TermDepositsOddDaysFCY extends BaseClass {

    String Txn;
    String FILE_PATH = System.getProperty("user.dir")+"\\Excel Data\\TDR\\TermDepositsOddDaysFCY.xlsx";

    @Test(groups = {"InputterTDR"}, dataProvider = "excelDataTermDepositsOddDaysFCY")

    public void TermDepositsOddDaysFCY(Map<String, String> testData) throws IOException, InterruptedException {

        PageObject.menu_Dropdown(" Centralized TDR ");
        PageObject.menu_Dropdown("Term Deposits - Odd Days");
        PageObject.menu_Link("Create Term Deposits FCY (Odd Days) ");
...
//        PageObject.click_Locator("fieldName:EXP.DATE");
        ...
        PageObject.commitDeal("TermDepositsOddDaysFCY");
...
//        PageObject.authorizeByTxn(testData.get("Transaction Number"));
    ...
    @DataProvider(name = "excelDataTermDepositsOddDaysFCY")
    ...
    public static void saveAccNumToFile(String accNumber) throws IOException {
        ...
        File file = new File(System.getProperty("user.dir") + "\\Data\\TermDepositsOddDaysFCY.xlsx");
    ...
    String FILE_PATH2 = System.getProperty("user.dir") + "\\Data\\TermDepositsOddDaysFCY.xlsx";

    @Test(groups = {"AuthorizerTDR"}, dataProvider = "DataTermDepositsOddDaysFCY")

    public void TermDepositsOddDaysFCYAuth(Map<String, String> testData) throws IOException, InterruptedException {
...
// MM2300400089
    ...
    @DataProvider(name = "DataTermDepositsOddDaysFCY")
