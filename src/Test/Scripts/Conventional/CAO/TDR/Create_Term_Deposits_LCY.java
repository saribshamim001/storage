...
public class Create_Term_Deposits_LCY extends BaseClass {

    String Txn;
    String FILE_PATH = System.getProperty("user.dir")+"\\Excel Data\\TDR\\Create_Term_Deposits_LCYData.xlsx";

    @Test(groups = {"InputterTDR"}, dataProvider = "excelDataCreate_Term_Deposits_LCY")

    public void Create_Term_Deposits_LCY(Map<String, String> testData) throws IOException, InterruptedException {

        PageObject.menu_Dropdown(" Centralized TDR ");
        PageObject.menu_Dropdown("Term Deposits - Rack Rate");
        PageObject.menu_Link("Create Term Deposits LCY  ");
...
//        PageObject.click_Locator("fieldName:EXP.DATE");
        ...
        PageObject.commitDeal("Create_Term_Deposits_LCY");
...
//        PageObject.authorizeByTxn(testData.get("Transaction Number"));
    ...
    @DataProvider(name = "excelDataCreate_Term_Deposits_LCY")
    ...
    public static void saveAccNumToFile(String accNumber) throws IOException {
        ...
        File file = new File(System.getProperty("user.dir") + "\\Data\\Create_Term_Deposits_LCY.xlsx");
    ...
    public void Create_Term_Deposits_LCYAuth(Map<String, String> testData) throws IOException, InterruptedException {
