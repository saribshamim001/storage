...
public class CDRDuplicateIssuance extends BaseClass {
    ...
    @Test( groups = {"Inputter"},  dataProvider = "excelDataCDRDuplicateinput")

    public void CDRDuplication(Map<String, String> testData) throws InterruptedException, IOException {
