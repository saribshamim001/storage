...
public class LockerInputter extends BaseClass {
    ...
    public void assignLocker() throws IOException, InterruptedException {
        ...
        PageObject.textinput_Locator("fieldName:KEY","6");
    ...
    public void assignLocker_Auth(Map<String, String> testData) throws IOException, InterruptedException {
        ...
        driver.findElement(By.xpath("//table/tbody/tr/td/a[text()='Authorise Locker Assign Charges'][1]")).click();
