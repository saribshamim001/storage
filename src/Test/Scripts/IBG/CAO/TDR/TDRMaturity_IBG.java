...
import java.util.Map;
    ...
    @Test(groups = {"InputterTDR_IBG"},dataProvider = "TDRIssuanceMaturityLCY_IBG")
        ...
        PageObject.textinput_Locator("fieldName:CUSTOMER.ID", testData.get("CUSTOMER.ID"));//11871120
    ...
    public Object[][] dataMethod() throws IOException {
        String FILE_PATH = System.getProperty("user.dir")+"\\Excel Data\\TDR\\TDRMaturity_IBG.xlsx";
...
//        rowCount=6;
    ...
    public void TDRAmendmentPreMaturity (Map<String, String> testData) throws IOException, InterruptedException {
        ...
        PageObject.textinput_Locator("value:1:1:1",testData.get("value:1:1:1"));//LD1430416803
