...
public class PostRestrictionMarking_IBG extends BaseClass {
    ...
    public void postRestrictionMarking_IBG() throws IOException {
        ...
        PageObject.textinput_Locator("value:1:1:1","16835783"); //1007891257
        ...
        PageObject.textinput_Locator("fieldName:POSTING.DATE:1","20221230");
