...
public class CDR_Cancellation_IBG extends BaseClass {
    ...
    @Test(groups = {"IBGInputter"},  dataProvider = "excelDataCDRCancellation")

    public void CDRCancellationIBG(Map<String, String> testData) throws IOException, InterruptedException {
