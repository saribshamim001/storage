...
public class LockerSurrender_IBG extends BaseClass {

        String SurrTxn;

    String FILE_PATH = System.getProperty("user.dir")+"\\Excel Data\\LockerSurrender_IBG.xlsx";


    @Test(groups = {"IBGInputter"}, dataProvider = "excelDataLockerSurrender_IBG")

        public void LockerSurrender_IBG(Map<String, String> testData) throws IOException, InterruptedException {
...
//        PageObject.menu_Dropdown("Alfalah Core/Retail Menu ");
        ...
        public static void saveAccNumToFile(String accNumber) throws IOException {
            ...
            File file = new File(System.getProperty("user.dir") + "\\Data\\LockerSurrenderIBG.xlsx");
    ...
    @DataProvider(name = "excelDataLockerSurrender_IBG")
    public Object[][] readExcelData1() throws IOException {
        ...
        public void lockerSurrender_AuthIBG() throws IOException, InterruptedException {
...
//        String menu2 = PageObject.switchToChildWindow();
        ...
        @DataProvider(name = "LockerSurrenderIBGData")
        public Object[][] LockerSurrenderIBGData() throws IOException {
            String FILE_PATH = System.getProperty("user.dir") + "\\Data\\LockerSurrenderIBGData.xlsx";
            FileInputStream fis = new FileInputStream(FILE_PATH);
            Workbook workbook = new XSSFWorkbook(fis);
            Sheet sheet = workbook.getSheetAt(0); // Assuming data is in the first sheet
            int rowCount = sheet.getPhysicalNumberOfRows();
