...
public class TDRIssuanceLCY_IBG extends BaseClass {

    @Test(groups = {"InputterTDR_IBG"})
    public void TDRIssuanceLCY_IBG () throws IOException, InterruptedException {
        ...
        PageObject.commitDeal("TDRIssuanceLCY_IBG");
