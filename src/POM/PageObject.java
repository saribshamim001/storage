...
//    }
    ...
    public static void autoGenerated(String text_Value , Integer index) {
        driver.findElement(By.xpath("(//table/tbody/tr/td/span[text()='"+text_Value+"'])["+index+"]")).click();
    }

    public static void authorizeDeal () {
        driver.findElement(By.xpath("//tr/td/a/img[@alt='Authorises a deal']")).click();
    }
    public static void expandSubvalue (String alt_Value , Integer index) {
        driver.findElement(By.xpath("(//tr/td/a/img[contains(@alt,'"+alt_Value+"')])["+index+"]")).click();
    }
    public static void main_menu (String alt_Value) {

        driver.findElement(By.xpath("//tr/td/input[@id='"+alt_Value+"']")).click();
