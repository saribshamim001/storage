...
public class stepDefinitions extends BaseClass {
    ...
    public void user_will_login_with_given_creds() {
        inputterLogin();
    }

    @Given("user will navigate to click on new deal for customer creation")
    public void user_will_navigate_to_click_on_new_deal_for_customer_creation() {
    ...
    public void user_will_fill_the_form_for_customer_creation() {
    ...
    public void user_will_validate_and_commit_the_form() {
